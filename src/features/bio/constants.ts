...
export const SIMPSONS_INFO = {
  [SimpsonsNames.BART]: {
    id: SimpsonsNames.BART,
    name: "Bart Simpson",
  ...
  [SimpsonsNames.MAGGIE]: {
    id: SimpsonsNames.MAGGIE,
    name: "Maggie Simpson",
